###2016-12-13日
新建了cjShop-service-rest工程.
用来发布搜索服务(solr)


###2016-10-16日
加入redis缓存. 单机和集群版都有.用接口和AOP容器,实现了从配置文件切换.
在rest工程的ContentServiceImpl类中,即轮播图的服务类中,加入了缓存.
编写了缓存同步.在ContentService里.
...
在service中,第一次用注解的方式,读取了配置文件中的内容.
